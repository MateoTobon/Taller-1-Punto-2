...
public class MaquinaDispensadora {
	...
	public static void main(String[] args) {
		...
		System.out.println("*El primer producto de la máquina es el " + arequipe.getNombre() + " y cuesta "
				+ arequipe.getPrecio() + "$" + "\n");
		System.out.println("*El segundo producto de la máquina es la " + avena.getNombre() + " y cuesta "
				+ avena.getPrecio() + "$" + "\n");
		System.out.println("*El tercer producto de la máquina es la " + barra.getNombre() + " y cuesta "
				+ barra.getPrecio() + "$" + "\n");
		System.out.println("*El cuarto producto de la máquina son los " + bimbo.getNombre() + " y cuesta "
				+ bimbo.getPrecio() + "$" + "\n");
		System.out.println("*El quinto producto de la máquina son los " + choclitos.getNombre() + " y cuesta "
				+ choclitos.getPrecio() + "$" + "\n");
		System.out.println("*El sexto producto de la máquina son los " + chococrispis.getNombre() + " y cuesta "
				+ chococrispis.getPrecio() + "$" + "\n");
		System.out.println("*El séptimo producto de la máquina es el " + gol.getNombre() + " y cuesta "
				+ gol.getPrecio() + "$" + "\n");
		System.out.println("*El octavo producto de la máquina es la " + jumbo.getNombre() + " y cuesta "
				+ jumbo.getPrecio() + "$" + "\n");
		System.out.println("*El noveno producto de la máquina es la " + mix.getNombre() + " y cuesta " + mix.getPrecio()
				+ "$" + "\n");
		System.out.println("*El décimo producto de la máquina es la " + galleta.getNombre() + " y cuesta "
				+ galleta.getPrecio() + "$" + "\n");
		...
		System.out.println("El total de unidades de todos los productos en la máquina son: "
